...
var hMB=_mz(z,'view',['bindtap',7,'class',1,'data-event-opts',2,'style',3],[],oJB,xIB,gg)
var oNB=_mz(z,'view',['class',11,'style',1],[],oJB,xIB,gg)
var cOB=_v()
_(oNB,cOB)
if(_oz(z,13,oJB,xIB,gg)){cOB.wxVkey=1
}
var oPB=_v()
_(oNB,oPB)
if(_oz(z,14,oJB,xIB,gg)){oPB.wxVkey=1
}
cOB.wxXCkey=1
oPB.wxXCkey=1
_(hMB,oNB)
...
bGB.wxXCkey=2
_2z(z,5,oHB,e,s,gg,bGB,'item','index','index')
}
var tEB=_v()
_(oBB,tEB)
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/index"],{"002b":function(e,t,a){"use strict";a.r(t);var i=a("72c6"),n=a.n(i);for(var s in i)"default"!==s&&function(e){a.d(t,e,function(){return i[e]})}(s);t["default"]=n.a},6895:function(e,t,a){"use strict";var i=a("a5d9"),n=a.n(i);n.a},"72c6":function(e,t,a){"use strict";(function(e,i){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,s=o(a("a096"));o(a("3680"));function o(e){return e&&e.__esModule?e:{default:e}}var r={data:function(){return{}},onLoad:function(){n=this,s.default.getArea(function(e){var t=e.data.htl_room_type_global_demands;t&&t.length>0&&(getApp().globalData.regions=t)},{display:"full",output_format:"JSON"})},methods:{getuserinfo:function(t){t.detail.iv?e.login({provider:"weixin",success:function(e){var t=e.code;n.getCustom(t)}}):e.showToast({title:"登陆失败",image:"../../static/info-icon.png",duration:2e3})},getCustom:function(t){s.default.getCustomer(function(t){if(void 0!==t.data.customers){var a=t.data.customers;getApp().globalData.isNewUser=!1;var i=a[0];if(i.address1=i.address,i.id_address=i.id,i.relationship=0,getApp().globalData.users[0]=n.addUsers(i),void 0!==i.associations)for(var s=i.associations.otherMembers,o=0;o<s.length;o++){var r=n.addUsers(s[o]);getApp().globalData.users.push(r)}e.switchTab({url:"/pages/main/main"})}else e.showToast({title:"请先注册用户信息",image:"../../static/info-icon.png",duration:2e3}),setTimeout(function(){e.switchTab({url:"/pages/user/user"})},2e3)},{display:"full","filter[user_name]":"["+t+"]","filter[login_type]":"1"})},appWxLogin:function(){e.showLoading({title:"加载中",mask:!0}),e.getProvider({service:"oauth",success:function(t){t.provider.indexOf("weixin")?e.login({provider:"weixin",success:function(e){console.log(i(e," at pages/index/index.vue:138"))}}):(e.hideLoading(),e.showToast({title:"请先安装微信",image:"../../static/info-icon.png",duration:2e3}))}})},addUsers:function(e){var t={id:e.id_address,lastname:e.lastname,firstname:e.firstname,sexes:0,birthDate:e.birthday,phone:e.phone,regions:0,address:e.address1,occupation:e.occupation,livings:0,flats:0,diseases:0,scares:0,ifs:[!1,!1,!1,!1,!1,!1,!1,!1],otherTxt:"",relationship:0},a=e.id_gender;2==a&&(t.sexes=1);for(var i=getApp().globalData.livings,n=0,s=0;s<i.length;s++)e.living_status==i[s]&&(n=s);t.livings=n;for(var o=getApp().globalData.flats,r=0,l=0;l<o.length;l++)e.home_type==o[l]&&(r=l);t.flats=r;for(var u=getApp().globalData.diseases,d=0,c=0;c<u.length;c++)e.health_status==u[c]&&(d=c);t.diseases=d;for(var f=getApp().globalData.scares,g=0,p=0;p<f.length;p++)e.special_care==f[p]&&(g=p);t.scares=g;var v=getApp().globalData.ifs,h=[];null!=e.special_care_detail&&(h=e.special_care_detail.split(","));for(var m=0;m<v.length;m++)for(var b=0;b<h.length;b++)h[b]==v[m].name&&(t.ifs[m]=!0,h[b]="");for(var _="",x=0;x<h.length;x++)""!=h[x]&&(_=h[x]);t.otherTxt=_;for(var w=getApp().globalData.regions,A=0,D=0;D<w.length;D++)e.id_global_demand==w[D].id&&(A=D);t.regions=A;var T=e.relationship;return T="兄弟"==T?1:"姐妹"==T?2:"儿女"==T?3:0,t.relationship=T,t}}};t.default=r}).call(this,a("6e42")["default"],a("0de9")["default"])},a5d9:function(e,t,a){},b114:function(e,t,a){"use strict";(function(e){a("faf8"),a("921b");i(a("66fd"));var t=i(a("ca28"));function i(e){return e&&e.__esModule?e:{default:e}}e(t.default)}).call(this,a("6e42")["createPage"])},ca28:function(e,t,a){"use strict";a.r(t);var i=a("fd33"),n=a("002b");for(var s in n)"default"!==s&&function(e){a.d(t,e,function(){return n[e]})}(s);a("6895");var o=a("2877"),r=Object(o["a"])(n["default"],i["a"],i["b"],!1,null,null,null);t["default"]=r.exports},fd33:function(e,t,a){"use strict";var i=function(){var e=this,t=e.$createElement;e._self._c},n=[];a.d(t,"a",function(){return i}),a.d(t,"b",function(){return n})}},[["b114","common/runtime","common/vendor"]]]);
});
