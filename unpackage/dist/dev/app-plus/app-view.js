...
Z([[7],[3,'regionIndex']])
Z(z[19])
Z([a,[[6],[[7],[3,'regions']],[[7],[3,'regionIndex']]]])
Z(z[9])
Z([3,'weui-cell '])
Z(z[11])
Z(z[12])
...
var xSM=_mz(z,'picker',['bindchange',27,'data-event-opts',1,'range',2,'value',3],[],e,s,gg)
var oTM=_n('view')
...
var cYM=_n('view')
_rz(z,cYM,'class',36,e,s,gg)
var oZM=_oz(z,37,e,s,gg)
_(cYM,oZM)
_(oXM,cYM)
_(hWM,oXM)
var l1M=_n('view')
_rz(z,l1M,'class',38,e,s,gg)
var a2M=_mz(z,'input',['bindinput',39,'class',1,'data-event-opts',2,'placeholder',3,'value',4],[],e,s,gg)
_(l1M,a2M)
_(hWM,l1M)
_(cVM,hWM)
_(eBM,cVM)
...
var o6M=_n('view')
_rz(z,o6M,'class',47,e,s,gg)
var x7M=_oz(z,48,e,s,gg)
_(o6M,x7M)
_(b5M,o6M)
_(e4M,b5M)
var o8M=_n('view')
_rz(z,o8M,'class',49,e,s,gg)
var f9M=_mz(z,'input',['bindinput',50,'class',1,'data-event-opts',2,'placeholder',3,'value',4],[],e,s,gg)
_(o8M,f9M)
_(e4M,o8M)
_(t3M,e4M)
_(eBM,t3M)
var c0M=_mz(z,'view',['class',55,'style',1],[],e,s,gg)
var hAN=_oz(z,57,e,s,gg)
_(c0M,hAN)
_(eBM,c0M)
var oBN=_n('view')
_rz(z,oBN,'class',58,e,s,gg)
var cCN=_n('radio-group')
_rz(z,cCN,'bindchange',59,e,s,gg)
var oDN=_v()
_(cCN,oDN)
var lEN=function(tGN,aFN,eHN,gg){
var oJN=_mz(z,'label',['bindtap',64,'class',1,'data-event-opts',2],[],tGN,aFN,gg)
var oLN=_n('view')
_rz(z,oLN,'class',67,tGN,aFN,gg)
var fMN=_oz(z,68,tGN,aFN,gg)
_(oLN,fMN)
_(oJN,oLN)
var xKN=_v()
_(oJN,xKN)
if(_oz(z,69,tGN,aFN,gg)){xKN.wxVkey=1
var cNN=_n('view')
_rz(z,cNN,'class',70,tGN,aFN,gg)
var hON=_mz(z,'icon',['class',71,'size',1,'type',2],[],tGN,aFN,gg)
_(cNN,hON)
_(xKN,cNN)
}
xKN.wxXCkey=1
...
oDN.wxXCkey=2
_2z(z,62,lEN,e,s,gg,oDN,'item','index','index')
_(oBN,cCN)
_(eBM,oBN)
var bCM=_v()
_(eBM,bCM)
if(_oz(z,74,e,s,gg)){bCM.wxVkey=1
var oPN=_n('view')
_rz(z,oPN,'class',75,e,s,gg)
var cQN=_n('view')
_rz(z,cQN,'class',76,e,s,gg)
var oRN=_n('view')
_rz(z,oRN,'class',77,e,s,gg)
var lSN=_oz(z,78,e,s,gg)
_(oRN,lSN)
_(cQN,oRN)
_(oPN,cQN)
var aTN=_n('view')
_rz(z,aTN,'class',79,e,s,gg)
var tUN=_mz(z,'picker',['bindchange',80,'data-event-opts',1,'end',2,'mode',3,'start',4,'value',5],[],e,s,gg)
var eVN=_n('view')
_rz(z,eVN,'class',86,e,s,gg)
var bWN=_oz(z,87,e,s,gg)
_(eVN,bWN)
_(tUN,eVN)
_(aTN,tUN)
_(oPN,aTN)
...
var oXN=_n('view')
_rz(z,oXN,'class',88,e,s,gg)
var xYN=_n('view')
_rz(z,xYN,'class',89,e,s,gg)
var oZN=_n('view')
_rz(z,oZN,'class',90,e,s,gg)
var f1N=_n('view')
_rz(z,f1N,'class',91,e,s,gg)
var c2N=_oz(z,92,e,s,gg)
_(f1N,c2N)
_(oZN,f1N)
_(xYN,oZN)
var h3N=_n('view')
_rz(z,h3N,'class',93,e,s,gg)
var o4N=_mz(z,'picker',['bindchange',94,'data-event-opts',1,'end',2,'mode',3,'start',4,'value',5],[],e,s,gg)
var c5N=_n('view')
_rz(z,c5N,'class',100,e,s,gg)
var o6N=_oz(z,101,e,s,gg)
_(c5N,o6N)
_(o4N,c5N)
_(h3N,o4N)
_(xYN,h3N)
...
_(eBM,oXN)
var l7N=_n('view')
_rz(z,l7N,'class',102,e,s,gg)
var a8N=_mz(z,'button',['bindtap',103,'data-event-opts',1,'disabled',2,'type',3],[],e,s,gg)
var t9N=_oz(z,107,e,s,gg)
_(a8N,t9N)
_(l7N,a8N)
_(eBM,l7N)
bCM.wxXCkey=1
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:95:15)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:95:15)",{path:"./app.wxss"});    
